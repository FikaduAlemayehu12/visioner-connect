      ...
      {conversations.map((c) => (
        ...
        >
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground font-bold text-sm overflow-hidden">
              {c.other_user_avatar ? (
  ...
  return (
    <>
      ...
      <div className="p-3 border-b border-border flex items-center gap-3">
        ...
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground font-bold text-xs overflow-hidden">
